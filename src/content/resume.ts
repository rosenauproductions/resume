...
/** Construction-flow network: crafts ↔ projects (shown above side-project cards) */
export const projectNetwork = {
  caption: "Construction flow · crafts feeding builds",
  nodes: [
    { id: "core", label: "Build\nflow", kind: "hub", x: 50, y: 48 },
    // craft hubs
    { id: "code", label: "Coding", kind: "craft", x: 18, y: 22 },
    { id: "web", label: "HTML /\nCSS / JS", kind: "craft", x: 38, y: 14 },
    { id: "graphics", label: "Graphics", kind: "craft", x: 62, y: 14 },
    { id: "video", label: "Video", kind: "craft", x: 82, y: 22 },
    { id: "ppt", label: "PPT →\nVideo", kind: "craft", x: 88, y: 48 },
    { id: "lms", label: "LMS /\nCanvas", kind: "craft", x: 82, y: 74 },
    { id: "ai", label: "AI\nworkflows", kind: "craft", x: 62, y: 86 },
    { id: "ux", label: "UX /\nInteractive", kind: "craft", x: 38, y: 86 },
    { id: "hardware", label: "Hardware\n/ Pi", kind: "craft", x: 18, y: 74 },
    // projects
    { id: "resume", label: "Resume\nsite", kind: "project", x: 28, y: 36 },
    { id: "pipeline", label: "Job\npipeline", kind: "project", x: 42, y: 32 },
    { id: "pistomp", label: "Pistomp\nMobile", kind: "project", x: 22, y: 54 },
    { id: "stepbot", label: "StepBot", kind: "project", x: 72, y: 58 },
    { id: "feud", label: "Family\nFeud", kind: "project", x: 48, y: 68 },
    { id: "onepct", label: "1%\nClub", kind: "project", x: 58, y: 72 },
    { id: "calendar", label: "Family\ncalendar", kind: "project", x: 32, y: 72 },
    { id: "hinter", label: "Hinterviewer", kind: "project", x: 70, y: 36 },
    { id: "ashurose", label: "Ashurose", kind: "project", x: 58, y: 30 },
    { id: "lobe", label: "Lobe", kind: "project", x: 28, y: 58 },
    { id: "synthesia", label: "Synthesia\nsystems", kind: "project", x: 78, y: 42 },
    { id: "courses", label: "Rise /\nStoryline", kind: "project", x: 72, y: 24 },
    { id: "pptwork", label: "Training\nvideo", kind: "project", x: 86, y: 62 },
  ],
  edges: [
    ["core", "code"],
    ["core", "web"],
