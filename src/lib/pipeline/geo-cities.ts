...
const CITY_COORDS: Record<string, GeoPoint> = {
  ...
  queens: { lat: 40.7282, lng: -73.7949, label: "Queens, NY" },
  ...
  bethesda: { lat: 38.9847, lng: -77.0947, label: "Bethesda, MD" },
  ...
  "council bluffs": { lat: 41.2619, lng: -95.8608, label: "Council Bluffs, IA" },
  ...
  boydton: { lat: 36.6676, lng: -78.3875, label: "Boydton, VA" },
  /** Rappahannock County seat — prefer over DC when region is VA */
  "washington va": { lat: 38.7134, lng: -78.1594, label: "Washington, VA" },
  washington: { lat: 38.9072, lng: -77.0369, label: "Washington, DC" },
  "washington dc": { lat: 38.9072, lng: -77.0369, label: "Washington, DC" },
  /** Collin County town (DFW) — not the state */
  nevada: { lat: 33.0423, lng: -96.3733, label: "Nevada, TX" },
